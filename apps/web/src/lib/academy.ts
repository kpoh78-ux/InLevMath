...
// 학생·학습지·교재·채점 결과를 전부 공유해야 한다.
//
// 예외: 수업 시간표(ClassSchedule)는 선생님마다 다르므로 여기를 거치지 않는다.
// 소유자가 수업을 맡은 선생님 본인이어야 누구 수업인지 가려지고, 그래야
// 지각 판정과 하원 리포트가 맞는다. /api/schedule 은 getTeacherAuth 를 쓴다.
//
